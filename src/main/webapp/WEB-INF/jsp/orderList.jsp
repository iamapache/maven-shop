...
<body>
		...
		<div class="span5">
			<div class="logo">
				<a href="./网上商城/index.htm"> <img
					src="${pageContext.request.contextPath}/resources/image/r___________renleipic_01/logo.gif"
					alt="传智播客" /> </a>
			</div>
		</div>
		<div class="span9">
			<div class="headerAd">
				<img src="${pageContext.request.contextPath}/resources/image/header.jpg"
				...
				<tbody>
					<s:iterator var="order" value="pageBean.list">
						...
						<s:iterator var="orderItem" value="#order.orderItems">
							<tr>
								<td width="60"><img
									src="${ pageContext.request.contextPath }/resources/<s:property value="#orderItem.product.image"/>" />
								</td>
	...
	<div class="container footer">
		<div class="span24">
			<div class="footerAd">
				<img src="resources/image\r___________renleipic_01/footer.jpg" alt="我们的优势"
