...
<div class="container header">
	...
	<div class="span9">
<div class="headerAd">
					<img src="resources/image\r___________renleipic_01/header.jpg" alt="正品保障" title="正品保障" height="50" width="320">
</div>	</div>
	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span18 last">
			...
			<div class="productImage">
					<a title="" style="outline-style: none; text-decoration: none;" id="zoom" href="http://resources/image/r___________renleipic_01/bigPic1ea8f1c9-8b8e-4262-8ca9-690912434692.jpg" rel="gallery">
			...
			<div id="bar" class="bar">
				...
				<div id="introduction" name="introduction" class="introduction">
					...
					<div>
						<img src="${pageContext.request.contextPath }/resources/<s:property value="model.image"/>">
					</div>
				</div>
...
<div class="container footer">
	<div class="span24">
		<div class="footerAd">
					<img src="resources/image\r___________renleipic_01/footer.jpg" alt="我们的优势" title="我们的优势" height="52" width="950">
</div>
</div>
	<div class="span24">
		<ul class="bottomNav">
